...
if __name__ == "main":
    ...
    # Question 2.b
    # ==============
    # x_bar = array([[0, 0, 0]]).transpose()

    # y_bar = c_matrix_4 @ x_bar
    # y_tilde = y_vector_4 - c_matrix_4 @ x_bar
    #
    ...
    #
    # p_hat = inv(c_matrix_4.transpose() @ c_matrix_4) @ c_matrix_4.\
    #     transpose() @ y_vector_4
    ...
    # ++++++++++++++++++++++++++++++++
    # ++++++++++++++++++++++++++++++++
    print("d'un seul coup :")
    p_hat_try, gamma_try = kalman(x0, gamma_0_matrix, zeros((3, 1)), y_vector_4,
                              gamma_alpha_matrix,
                              gamma_beta, a_matrix, c_matrix_4)
    print("HAT TRY", p_hat_try)
    print("\n")
    # ++++++++++++++++++++++++++++++++
    # ++++++++++++++++++++++++++++++++
    ...
    # ==============
    # a - b
    print("les différences entre moindres carrés et BLUE :\n")
    print(p_chap - p_hat)
    print("\n")
    # a - c
